...
/* ---------------------------------------------------------------------------*/
/**
 * @brief queueGetLength 返回当前队列消息数量
 *
 * @param This
 *
 * @returns 返回数量
 */
/* ---------------------------------------------------------------------------*/
static int queueGetLength(Queue *This)
{
	return This->priv->current_length;	
}
/* ----------------------------------------------------------------*/
/**
...
Queue * queueCreate(char *queue_name,QueueType type,unsigned int Size)
{
	...
	This->post = queuePost;
	This->get = queueGet;
	This->getCurLength = queueGetLength;
